...
import SoftwareModel from '../../models/software/softwareModel.js';


// CREATE POST
const createSoftwareController = async (req, res) => {
  try {
    const { basicInfo, specification, socialMedia, prosCons, pricing, messages, featuredLinks, comparisons, productAds, videos, screenShots, profileClaimed, publisher, articles, categories, reviews } = req.body;
    ...
    if (createSoftware) {
      res.status(201).json({
        ...
        featuredLinks: createSoftware.featuredLinks,
